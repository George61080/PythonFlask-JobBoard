...
def review(employer_id):
    if request.method == 'POST':
        ...
        date = datetime.date.now().strftime("%m/%d/%Y")
        execute_sql('INSERT INTO review (review, rating, title, date, status, employer_id) VALUES(?, ?, ?, ?, ?, ?)',(review, rating, tutle, date, status, employer_id), commit=True)
